...
public class PersonDao {
	...
	public void create(String firstName, String middleName, String lastName, String email, String phone, String residence) {
        ...
        insert.update("INSERT INTO public.\"Person\"(\r\n" + 
        		"	\"ID\", \"First Name\", \"Middle Name\", \"Last Name\", \"Email\", \"Phone\", \"Residence\")\r\n" + 
        		"	VALUES (?, ?, ?, ?, ?, ?, ?);",
                new Object[] { firstName, middleName, lastName, email,  phone, residence});
	}

	public List<Object> select(String email) {
	...
	public void delete(String email) {
		JdbcTemplate delete = new JdbcTemplate(dataSource);
        delete.update("SELECT \"ID\", \"First Name\", \"Middle Name\", \"Last Name\", \"Email\", \"Phone\", \"Residence\"\r\nFROM public.\"Person\" WHERE \"Email\" = ?;",
                new Object[] { email });
	}
